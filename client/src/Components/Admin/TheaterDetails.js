...
import {MDBContainer, CardBody, MDBIcon,MDBModal,
    MDBModalBody,
    MDBModalHeader,
    MDBModalFooter,
        ...
        <MDBContainer>
            <Card>
                <CardBody>
                        ...
                        <h6>Address: {this.state.theaterInfo.Street},{this.state.theaterInfo.City},{this.state.theaterInfo.Zipcode}</h6>
                        <h6>Country: {this.state.theaterInfo.Country}</h6>
                        <MDBIcon icon="edit" className="mr-1 ext-black" onClick= {()=>this.handleEdit(this.state.theaterInfo)}/><strong>Edit</strong>
                                    ...
                                    <form>
                                        <div className="md-form-group ">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-4">
                                                    <label>PLZ:</label>
                                                    <input type="text" value={this.state.theaterInfo.Zipcode} id="Zipcode" className="form-control" onChange={this.handleChange}/>
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="col-6">
                                                    <label>City:</label>
                                                    <input type="text" value={this.state.theaterInfo.City} id="City" className="form-control" onChange={this.handleChange}/>
                                                </div>
                                                <div className="col-6">
                                                    <label>Country:</label>
                                                    <input type="text" value={this.state.theaterInfo.Country} id="Country" className="form-control" onChange={this.handleChange}/>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
